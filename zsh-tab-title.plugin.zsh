...
typeset -gA ZSH_TAB_TITLE_ICONS=(
  [alacritty]=""
  [ansible]=""
  [ant]=""
  [apache2]=""
...
ZSH_TAB_TITLE_DEFAULT_ICON=""

function _zsh_tab_title_get_icon {
  local cmd="$1"
  echo "${ZSH_TAB_TITLE_ICONS[$cmd]:-$ZSH_TAB_TITLE_DEFAULT_ICON}"
}
...
function omz_termsupport_precmd {
  ...
  local ICON="$(_zsh_tab_title_get_icon "zsh")"
...
function omz_termsupport_preexec {
  ...
  local LINE="${2:gs/%/%%}"
  local ICON="$(_zsh_tab_title_get_icon "$CMD")"
